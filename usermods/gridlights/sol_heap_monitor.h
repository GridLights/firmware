...
/*
 * sol_heap_monitor.h — Detailed ESP32 Heap Monitoring Usermod
 * 
...
#ifdef USERMOD_SOL_HEAP_MONITOR

#include "wled.h"
#include <esp_heap_caps.h>
#include <esp_system.h>

class SolHeapMonitorUsermod : public Usermod {
public:
...
const char SolHeapMonitorUsermod::_name[] PROGMEM = "Sol_Heap_Monitor";

#endif // USERMOD_SOL_HEAP_MONITOR
